...
#define JOYSTICK_UP ADC14->MEM[0] < 2000 && ADC14->MEM[1] > 11000
#define JOYSTICK_DOWN ADC14->MEM[0] < 9500 && ADC14->MEM[0] >=2000 && ADC14->MEM[1] > 11000
#define JOYSTICK_LEFT ADC14->MEM[1] < 2000 && ADC14->MEM[0] > 11000
#define JOYSTICK_RIGHT ADC14->MEM[0] > 11000 && ADC14->MEM[1] < 9500 && ADC14->MEM[1] >=2000
