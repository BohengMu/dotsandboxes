...
#define JOYSTICK_NEUTRAL ADC14->MEM[0] < 9500 && ADC14->MEM[0] > 6883 && ADC14->MEM[1] < 9500 && ADC14->MEM[1] > 6883
#define JOYSTICK_UP ADC14->MEM[1] >= 9500
#define JOYSTICK_DOWN ADC14->MEM[1] <= 6883
#define JOYSTICK_LEFT ADC14->MEM[0] >=9500
#define JOYSTICK_RIGHT ADC14->MEM[0] <= 6883
